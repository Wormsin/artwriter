...
def get_stage4_prompt(num_series):
    ...
    [ВХОДНЫЕ ФАЙЛЫ]
    db_facts_checked.txt: Файл с проверенными гипотезами (все сведения по одной гипотезе содержатся внутри блока [НАЧАЛО ПРОВЕРКИ ГИПОТЕЗЫ][КОНЕЦ ПРОВЕРКИ ГИПОТЕЗЫ]).
