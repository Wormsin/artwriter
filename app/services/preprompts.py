    ...
    match lens_num:
        case 1:
            prompt = """
                    ...
                    ОПИСАНИЕ: [описание полученной информации] / БАЗА: [прямое описание факта из файлов, к чему относится информация]
        ...
        case 2:
            prompt = """
                    ...
                    ОПИСАНИЕ: [описание найденной темы] / БАЗА: [прямое описание факта из файлов, к чему относится информация]
        ...
        case 3:
            prompt = """
                    ...
                    ОПИСАНИЕ: [описание найденной личности] / БАЗА: [прямое описание факта из файлов, к чему относится информация]
